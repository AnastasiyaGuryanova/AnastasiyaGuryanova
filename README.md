## О себе
Frontend-разработчик с фокусом на **React**, **TypeScript** и **Next.js**. Стремлюсь создавать производительные веб-приложения, улучшающие UX и бизнес-метрики. Благодаря навыкам **FrontOps** (CI/CD, Docker, Nginx) я ускоряю доставку приложений в продакшен и эффективно взаимодействую с DevOps-командами. Быстро адаптируюсь к новым стекам и задачам, умею самостоятельно закрывать задачи и вести отчётность по прогрессу.
...
**Frontend-разработчик - 2г. (Внештатный frontend-разработчик (контракт) с опытом создания и поддержки SaaS-продуктов)**  
*Сентябрь 2023 – Август 2025*  
- **Разработала интерактивные UI** с **React**, **TypeScript**, **Next.js** (SSR/SPA): внедрила адаптивные интерфейсы, ориентируясь на UX для мобильных и десктопных пользователей.  
...
- **Реализовала безопасную авторизацию**: интегрировала **JWT**, **bcrypt** и **NextAuth.js** организовав ролевую модель доступа и защищая пользовательские данные для SaaS и event-driven платформ.
...
- **Проводила аудит и оптимизацию производительности (Lighthouse, web-vitals)**: выявляла узкие места, внедряла **best practices** по загрузке и безопасности фронта.
- **Конфигурировала сборку и автоматизацию (Webpack, Vite)**: реализовала **code-splitting**, оптимизацию статических ресурсов и **PWA**.
