...
**Фронтенд-разработчик (Фриланс / Проектная деятельность)**  
...
- **Настроила CI/CD и деплой**: использовала Docker, Nginx, Certbot (Tic-Tac-Toe) и GitLab CI/CD, сократив время доставки приложений в продакшен на 40% и обеспечив безопасный доступ через HTTPS
